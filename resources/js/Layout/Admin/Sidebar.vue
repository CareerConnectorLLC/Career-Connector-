<template>
    <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme" @mouseenter="toggleMenuHover" @mouseleave="removeMenuHover">
        ...
        <ul class="menu-inner py-1">
            <li class="menu-item" :class="{ 'active': $page.url.startsWith('/admin/dashboard') }">
                ...
                <!-- <Icon class="menu-icon" icon="ic:round-home" width="24" height="24" /> -->
                <Icon icon="iconoir:home-simple" width="21" height="21" class="menu-icon"/>
                <div>Dashboard</div>
                </Link>
            </li>

            <li class="menu-item" :class="{ 'open': $page.url.startsWith('/admin/users/') || $page.url.startsWith('/admin/service-providers/') }">
                <a href="javascript:void(0);" class="menu-link menu-toggle"  :class="{ 'active': $page.url.startsWith('/admin/users/list') }">
                  <!-- <i class="menu-icon tf-icons ti ti-smart-home"></i> -->
                  <Icon icon="ph:users-light" width="21" height="21" class="menu-icon" />
                  <div data-i18n="Dashboards">Users</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item" :class="{ 'active': $page.url.startsWith('/admin/users/list') || $page.url.startsWith('/admin/users/create') }">
                    <Link :href="route('admin.users.list')" class="menu-link" >
                      <div data-i18n="List">Clients</div>
                    </Link>
                  </li>
                  <li class="menu-item" :class="{ 'active': $page.url.startsWith('/admin/service-providers/list') || $page.url.startsWith('/admin/service-providers/create') }">
            ...
            <!-- 
              <li class="menu-item" :class="{ 'open': $page.url.startsWith('/admin/faq/') }">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  <Icon icon="qlementine-icons:faq-16" width="20" height="20" class="menu-icon" />
                  <div>FAQ</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item" :class="{ 'active': $page.url.startsWith('/admin/faq/list') }">
                    <Link :href="route('admin.faq.list')" class="menu-link" >
                      <div data-i18n="List">List</div>
                    </Link>
                  </li>
                  <li class="menu-item" :class="{ 'active': $page.url.startsWith('/admin/faq/create') }">
                    <Link :href="route('admin.faq.create')" class="menu-link">
                      <div >Create</div>
                    </Link>
                  </li>
                </ul>
            ...
            <!-- <li class="menu-item" :class="{ 'open': $page.url.startsWith('/admin/location/') }">
                <a href="javascript:void(0);" class="menu-link menu-toggle">
                  <Icon icon="mdi:location" width="21" height="21" class="menu-icon" />
                  <div data-i18n="Dashboards">Service Location</div>
                </a>
                <ul class="menu-sub">
                  <li class="menu-item" :class="{ 'active': $page.url.startsWith('/admin/location/list') }">
                    <Link :href="route('admin.location.list')" class="menu-link" >
                      <div data-i18n="List">List</div>
                    </Link>
                  </li>
                  <li class="menu-item" :class="{ 'active': $page.url.startsWith('/admin/location/create') }">
                    <Link :href="route('admin.location.create')" class="menu-link">
                      <div >Create</div>
                    </Link>
                  </li>
                </ul>
