<template>
        ...
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="dropdown">
              <Link :href="route('admin.faq.create')" class="btn rounded-pill btn-outline-primary waves-effect">+ Add FAQ</Link>
            </div>
          </div>
       <div class="card-body">
            <DataTable :value="store.list" lazy showGridlines @page="store.onPage" @sort="store.onSort"
               ...
               <template #header>
                ...
                <Column field="question" header="Question" sortable  style="width: 80%;"/>
            <!--  
                    ...
                    <template #body="slotData">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <Link :href="route('admin.faq.edit', slotData.data.id)" class="dropdown-item"><i class="ti ti-edit me-1"></i>
                                    Edit</Link>
...
<script setup>
    ...
    onMounted(() => {
        nextTick(() => {
            emit.emit('pageName', 'FAQ', [{ title: 'FAQ', routeName: "" }]);
            store.getFaqs();
        });
    });
    ...
    const confirmDelete = (id) => {
        confirm.require({
            ...
            accept: () => {
                store.deleteFaq(id);
                store.toast.add({ severity: 'info', summary: 'Confirmed', detail: 'The FAQ has been deleted', life: 3000 });
            },
            reject: () => {
