<template>
    <div class="card">
        <div class="card-header d-flex justify-content-between">
            ...
            <div class="dropdown">
                <Link :href="route('admin.service.create')" class="btn rounded-pill btn-outline-primary waves-effect">+
                Add Service</Link>
            </div>
        </div>
        <div class="card-body">
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <div class="input-group input-group-sm w-auto">
                            ...
                            <input type="text" class="form-control" placeholder="Search..."
                                v-model="store.filters.global" @input="store.onSearchQuery()">
                        </div>
                    </div>
                </template>
                ...
                <Column field="active" header="Status" sortable>
                    <template #body="slotData"><span class="badge cursor-pointer"
                            :class="{ 'bg-label-danger': (slotData.data.active != 1), 'bg-label-success': (slotData.data.active == 1) }">{{ (slotData.data.active
                                == 1) ? 'Active' : 'Inactive'}}</span></template>
                </Column>
                    ...
                    <template #body="slotData">
                        <div class="dropdown">
                            ...
                            <div class="dropdown-menu">
                                <Link class="dropdown-item" :href="'#'"><i class="ti ti-eye me-1"></i> View Details
                                </Link>
                                <Link :href="route('admin.service.edit', slotData.data.id)" class="dropdown-item"><i
