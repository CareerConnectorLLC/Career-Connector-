            ...
            <form @submit.prevent="submit()" enctype="multipart/form-data">
                <div class="form-group validated row">
                    <div class="form-group col-lg-6 mb-3">
                        ...
                        <input type="text" id="name" v-model="store.form.name"
                            class="form-control border-gray-200" placeholder="Full Name">
                        <span class="text-danger" v-if="store.form.errors?.name">{{
                            store.form.errors?.name[0] }}</span>
                    </div>
