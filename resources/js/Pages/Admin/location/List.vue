<template>
    ...
    <div class="card-header d-flex justify-content-between">
        ...
        <div class="dropdown">
          <Link :href="route('admin.category.create')" class="btn rounded-pill btn-outline-primary waves-effect">+ Add Location</Link>
        </div>
      </div>
   <div class="card-body">
        <DataTable :value="store.list" lazy showGridlines @page="store.onPage" @sort="store.onSort"
           ...
           <template #header>
            ...
            <Column field="name" header="Location Name" sortable  style="width: 90%;"/>
                ...
                <template #body="slotData">
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <Link :href="route('admin.location.edit', slotData.data.id)" class="dropdown-item"><i class="ti ti-edit me-1"></i>
                                Edit</Link>
...
onMounted(() => {
    nextTick(() => {
        emit.emit('pageName', 'Location', [{ title: 'Locations', routeName: "" }]);
        store.getLocations();
    });
});
